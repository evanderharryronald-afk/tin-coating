...
# 3. 抗震荡模型定义
# ==========================================
class SmoothResidualModel:
    def __init__(self, alpha_smoothing=0.2):
...
# 4. 表面建模与图形输出
# ==========================================
def run_surface_pipeline(df, surface='Top'):
    prefix = 'Top' if surface == 'Top' else 'Bot'
    surface_cn = '上' if surface == 'Top' else '下'
...
if __name__ == "__main__":
    ...
    # 步骤 2: 分别训练上/下表面模型
    run_surface_pipeline(clean_df, surface='Top')
    run_surface_pipeline(clean_df, surface='Bot')